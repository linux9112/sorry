    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          ...
          >
            Ham sahi main nahi na sak karte hai, wesa nahi hai, sachi main motko mera bolne ka wesa koe mtlb nahi tha
          </motion.p>
          ...
          >
            Ham bina bole ye sab sone wale the parso par payar na karte hai bina lade kyu sote aur  par sorry na ham kuch jada hi kar diye, sorry na babu hamko laga tha saturday nahi hai toh aaj free nahi hogi dost log se baat kar rahi hogi esliye late reply kar rahi ho, yesa laga tha bas thora overthink na karne lag jaate hai kya kare par wesa nahi kabhi soche hai jesa tumko lag raha hai , Babu maan jao na ho gya galti se 
          </motion.p>
          <motion.p
          ...
          >
            Ettu sa lad hi sakte hai na dono esme jada der gussa nahi na raho
          </motion.p>
